...
public class CommentController {
	...
	public List<Comment> commentList(@PathVariable long board_id, @PathVariable long post_id, Model model) {
		List<Comment> cList = commentService.getAllCommentList(post_id);
		return cList;
	}

	//delete
	@DeleteMapping("/{post_id}/{commentId}")
	public void deleteComment(@PathVariable long post_id, @PathVariable long commentId) {
